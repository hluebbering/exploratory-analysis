...
fig <- fig %>% layout(geo = g, showlegend = FALSE)
...
p <- df_total %>%
  ...
  geom_bar(stat="identity") + scale_fill_manual(values = rhg_cols) + theme_ipsum() +
  scale_y_continuous(labels = label_number(suffix = " M", scale = 1e-6)) +
  labs(title="Total CO2 Emissions By Country | 1960-2018", x = "Country", y="Thousand metric tons of CO2")+ 
  theme(legend.position = "none",
        plot.title = element_text(size = 10, color="#36454f", family = "Frank Ruhl Libre"),
